...
public class SendMail {
	...
	public  void mail(String message, User user) {
		try {
			...
			Session session = Session.getInstance(
					...
					new javax.mail.Authenticator() {
						protected PasswordAuthentication getPasswordAuthentication() {
							...
							return new PasswordAuthentication("test.receiver@kanda-it-school-system.com\n"
									+ "", "kandaReceiver");
						}
					});
			...
			mimeMessage.setRecipients(Message.RecipientType.TO, "@docomo.ne.jp");

			// メールのタイトルを指定
			mimeMessage.setSubject(user.getUser_nickname()+"様", "iso-2022-jp");
